...
_Generated by Hermes Session Digest · {total_clusters} cluster(s) from {total_sessions} session(s){f" · {telegram_count} Telegram session{'s' if telegram_count > 1 else ''}" if telegram_count else ""}_
